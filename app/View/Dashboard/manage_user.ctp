<div class="container">
        ...
        <div class="row">
          <div class="col-sm-10">
            ...
            <div class="srchBlock">
              <form class="form-inline" method="post" action="<?php echo HTTP_ROOT?>dashboard/manageUser">
              <form accept-charset="utf-8" method="post" id="searchFormIndexForm" action="<?php echo HTTP_ROOT?>dashboard/searchBusiness">
                ...
                <input type="text" class="form-control fieldtext" id="inputPassword2" placeholder="type and search here" name="data[searchForm][search]">
              ...
              <table class="table table-bordered table-striped">
               ...
               <tr>
                             <th scope="row"><?php echo h($key+1); ?></th>
                              ...
                              <?php $date = strtotime($business['Business']['createdat']);
                                    $dat = date('Y-m-d', $date);
